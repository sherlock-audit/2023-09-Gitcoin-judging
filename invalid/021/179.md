...
# Allo#_createPool - if user sent exactly baseFee+amount, transaction reverts
## Summary
...
## Recommendation
Change the check from `(baseFee + _amount >= msg.value)` to strictly `(baseFee + _amount > msg.value)`